...
### 1. Полностью переписан модуль `ajax.js`
...
### 4. Сохранена обратная совместимость архитектуры
...
> **Важно:** Проект по-прежнему использует нативные ES-модули и не требует сборки.
